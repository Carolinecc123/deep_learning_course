...
class Adam(Optimizer):
    ...
    def update(self, layer):
        ...
        for n, dv in layer.grads.items():
            ...
            m_dot = self.mt[n] / (1- (self.beta1 ** self.t))
            v_dot = self.vt[n] / (1 - (self.beta2 ** self.t))
            layer.params[n] -= (self.lr * m_dot) / (np.sqrt(v_dot) + self.eps)
